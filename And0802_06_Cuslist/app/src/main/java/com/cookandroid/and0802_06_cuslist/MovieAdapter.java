...
public class MovieAdapter extends BaseAdapter {
    Context context; //메인엑티비티 컨텍스트 저장 변수
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        img.setImageDrawable(data.get(i).getImage()); //movie 의 image 변수값 가져와서 연결
        txtTitle.setText(data.get(i).getTitle()); //movie 의 title 변수값 가져와서 연결
        txtGenre.setText(data.get(i).getGenre()); //movie 의 Denre 변수값 가져와서 연결
        return view;
    }
}
