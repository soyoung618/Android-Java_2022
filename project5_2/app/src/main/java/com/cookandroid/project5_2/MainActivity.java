...
public class MainActivity extends AppCompatActivity {
    ...
    Integer[] btnIDs={R.id.btnAdd, R.id.btnSub, R.id.btnMud, R.id.btnDiv };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtResult= findViewById(R.id.txtReault);
        /////////////////////////////////////////////////////////
        for(int i=0; i<btnNums.length; i++) //0~9버튼
            btnNums[i] = findViewById(btnNumIDs[i]);
        //////////////////////////////////////////////////
        for(int i=0; i<btnNums.length; i++){ //0~9버튼처리작업
            final int index =i;
            ...
            btns[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    switch (view.getId()){
                        ...
                        case R.id.btnMud : result = x*y; break;
